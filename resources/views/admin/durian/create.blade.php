            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6 flex items-center">
                        ...
                        <h2 class="text-xl font-bold">Add New Durian Type</h2>
                    </div>
                    
                    <form method="POST" action="{{ route('durian.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="total" class="form-label">Initial Quantity</label>
                            <input type="number" name="total" id="total" class="form-input" required>
                        </div>
