<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Orchard Monitoring Dashboard') }}
            </h2>
            <button onclick="openModal('addOrchardModal')" class="btn-primary flex items-center">
    ...
    <div class="orchard-dashboard py-6">
                    ...
                    <div class="orchard-card">
                        ...
                        <div class="orchard-card-footer">
                            <div class="flex space-x-2">
                                ...
                                <button onclick="openViewModal({{ $orchard->id }})" class="btn-secondary flex-1 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <form method="POST" action="{{ route('orchards.destroy', $orchard->id) }}" class="flex-none">
                                    @csrf @method('DELETE')
    ...
    <div id="addOrchardModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="modal-content p-6 max-w-lg w-full">
            ...
            <form action="{{ route('orchards.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="orchardSize" id="orchardSize" class="form-input" required>
                </div>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function() {
        setTimeout(function() {
            ...
            document.getElementById('total-durian-falls').innerText = totalFalls;
        }, 2000); // Give time for the individual counts to load
    });
</script>
